...
function hybrid_get_sidebars() {
    ...
    $sidebars = array(
        'logo' => array(
            'name' => _x('Logo', 'sidebar', 'hybrid-core'),
            'description' => __("Displayed within the site's logo area.", 'hybrid-core'),
        ),
        'portfolio' => array(
            'name' => _x('Portfolio Default', 'sidebar', 'hybrid-core'),
            'description' => __('Loaded after the home page content area with width default.', 'hybrid-core'),
        ),
        'portfolio-full' => array(
            'name' => _x('Portfolio Full', 'sidebar', 'hybrid-core'),
            'description' => __('Loaded after the home page content area with full width.', 'hybrid-core'),
        ),
        'primary' => array(
        ...
        'left-sidebar' => array(
            'name' => _x('Left Sidebar', 'sidebar', 'hybrid-core'),
            'description' => __('Load the "page template" on the left sidebar.', 'hybrid-core'),
        ),
        'right-sidebar' => array(
            'name' => _x('Right Sidebar', 'sidebar', 'hybrid-core'),
            'description' => __('Load the "page template" on the right sidebar.', 'hybrid-core'),
        ),
        'blog' => array(
            'name' => _x('Blog', 'sidebar', 'hybrid-core'),
            'description' => __('Load the "page template" on the Blog.', 'hybrid-core'),
        ),
        'clients' => array(
            'name' => _x('Clients', 'sidebar', 'hybrid-core'),
            'description' => __('Load the "page template" on the Clients.', 'hybrid-core'),
        )
    );
