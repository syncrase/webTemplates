...
jQuery(window).load(function(){
	...
	if( personnal_widget.length > 0 ){
		personnal_widget.each(function(){
			var personnal_nav = jQuery(this).siblings('.personnal-widget-navigation');
			gdl_cycle_resize(jQuery(this));
			jQuery(this).cycle({ fx: 'fade', slideResize: 1, fit: true, width: '100%',
