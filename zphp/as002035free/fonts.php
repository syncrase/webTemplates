...
function fontChooser($fontfamily)
{
	...
	switch($fontfamily)
	{
		...
		case 'Numans':
			...
			break;	
		case 'Open Sans':
			$font_arr['fontlink'] = "<link href='http://fonts.googleapis.com/css?family=Open+Sans:400,300,300italic,400italic,600,600italic,700,700italic,800,800italic&subset=latin,cyrillic-ext,greek-ext,vietnamese,latin-ext' rel='stylesheet' type='text/css'>";
			$font_arr['fontfamily'] = "font-family: 'Open Sans', Arial, serif !important;";
			break;
		case 'Open Sans Condensed':
			$font_arr['fontlink'] = "<link href='http://fonts.googleapis.com/css?family=Open+Sans+Condensed:300,300italic,700&subset=latin,cyrillic-ext,greek-ext,vietnamese,latin-ext' rel='stylesheet' type='text/css'>";
